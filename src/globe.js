...
// This will measure the parent div and feed the size to the Globe component
...
    updateDimensions();
    ...
    // Use ResizeObserver to update dimensions if the window changes
...
  const containerRef = useRef(null);
  // 2. Get dimensions from the container ref using our new hook
...
  // Show loading until the container has been measured (width > 0)
  if (data.length === 0 || width === 0) {
    return <div ref={containerRef} style={{width: "100%", height: "100%"}}>Loading country globe...</div>;
  }

  return (
    // 3. Apply the ref to the container div
    <div ref={containerRef} style={{ width: "100%", height: "100%", position: "relative" }}>
  	  <Globe
        // 4. Pass the measured width and height to the Globe component
        width={width}
        height={height}
...
export default React.memo(MyGlobe);
